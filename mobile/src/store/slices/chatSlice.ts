...
const initialState: ChatState = { messages: [], unreadCount: 0, isOpen: false, typingUsers: [] };
...
export const { setMessages, addMessage, toggleChat, clearUnread, addTypingUser, removeTypingUser, resetChat } = chatSlice.actions;
